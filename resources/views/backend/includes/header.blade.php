...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('public/backend/images/favicon2.ico')}}" type="image/x-icon" />
    ...
    {{-- <link rel="stylesheet" href="{{asset('public/backend/vendors/font-awesome/css/fontawesome.css')}}"> --}}
    ...
    <link rel="stylesheet" href="{{asset('public/backend/vendors/datatables.net-bs4/css/dataTables.bootstrap4.min.css')}}">
    <link rel="stylesheet" href="{{asset('public/backend/vendors/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css')}}">
                    ...
                    <div class="header-left">
                        ...
                        {{-- <div class="dropdown for-notification">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="padding-top: 0px">
                                <img src="{{asset('public/backend/images/iconfinder_icon-ios7-bell-outline_211693.png')}}" style="width: 1.4rem"/>
